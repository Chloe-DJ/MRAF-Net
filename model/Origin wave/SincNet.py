...
#SincNet 第一层是 可学习的滤波器参数，对学习率比较敏感。
#通常推荐 0.001 – 0.01 之间开始尝试。
...
class SincNet(nn.Module):
    ...
    def __init__(self, args):
        ...
        self.cnn_N_filt = args.cnn_N_filt
        self.cnn_len_filt = args.cnn_len_filt
        self.cnn_max_pool_len = args.cnn_max_pool_len

        self.cnn_act = args.cnn_act
        self.cnn_drop = args.cnn_drop

        self.cnn_use_laynorm = args.cnn_use_laynorm
        self.cnn_use_batchnorm = args.cnn_use_batchnorm
        self.cnn_use_laynorm_inp = args.cnn_use_laynorm_inp
        self.cnn_use_batchnorm_inp = args.cnn_use_batchnorm_inp

        self.input_dim = int(args.input_dim)

        self.fs = args.fs

        self.N_cnn_lay = len(args.cnn_N_filt)
